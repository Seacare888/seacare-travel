...
import { MapPinIcon, ClockIcon, StarIcon, ShieldCheckIcon, HeartIcon, AwardIcon, SearchIcon, ChevronLeftIcon, ChevronRightIcon, PhoneIcon, MailIcon, SendIcon } from 'lucide-react';
      ...
      <section id="contact" className="py-16 px-4 bg-gradient-to-br from-[#0066cc] to-[#0052a3]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <p className="text-white/85 text-lg mb-8 leading-relaxed">ติดต่อเราเพื่อรับคำปรึกษาฟรี ทีมงานมืออาชีพพร้อมออกแบบทริปที่ใช่</p>
          ...
          <div className="bg-white rounded-2xl p-7 shadow-xl">
            <h3 className="text-lg font-bold text-gray-800 mb-5">ขอคำปรึกษาฟรี</h3>
            <form onSubmit={handleContact} className="space-y-3">
              ...
              <textarea className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm outline-none focus:border-[#0066cc] resize-none h-24" placeholder="รายละเอียดที่ต้องการ..." value={form.message} onChange={e => setForm({...form, message: e.target.value})} />
              <button type="submit" className="w-full bg-[#0066cc] text-white rounded-full py-2.5 font-semibold flex items-center justify-center gap-2 hover:bg-[#0052a3]">
                <SendIcon className="w-4 h-4" />ส่งข้อมูล
              </button>
            </form>
          </div>
        </div>
