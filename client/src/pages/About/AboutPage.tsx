            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="bg-gray-50 p-8 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-gray-100">
                ...
                <div className="mt-4 flex items-center gap-2">
                  ...
                  <span className="text-[#06C755] font-bold text-lg">@golfseacare</span>
                </div>
              ...
              <div className="p-8 flex flex-col justify-center space-y-5">
                ...
                <a href="tel:028889999" className="flex items-center gap-4 hover:bg-blue-50 rounded-xl p-3 -m-3 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-800 text-sm">02-888-9999</p>
                  </div>
                </a>

                <a href="mailto:contact@seacare-travel.co.th" className="flex items-center gap-4 hover:bg-blue-50 rounded-xl p-3 -m-3 transition-colors">
                  <div className="w-11 h-11 rounded-full bg-blue-50 flex items-center justify-center flex-shrink-0">
                    <MailIcon className="w-5 h-5 text-[#0066cc]" />
                  </div>
                  <div>
                    <p className="text-xs text-gray-400">อีเมล</p>
                    <p className="font-semibold text-gray-800 text-sm">contact@seacare-travel.co.th</p>
                  </div>
                </a>
                ...
                <div className="flex items-center gap-4 p-3 -m-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-800 text-sm">อาคารสีลมคอมเพล็กซ์ ชั้น 18 กรุงเทพฯ</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-3 -m-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-800 text-sm">จันทร์-อาทิตย์ 9:00-21:00 น.</p>
                  </div>
                </div>
              </div>
            </div>
